...
public class NumberBySpeciesMapperTest {
    @Mock
    private Mapper.Context context;
    private NumberBySpeciesMapper numberBySpeciesMapper;

    @Before
    public void setup() {
        this.numberBySpeciesMapper = new NumberBySpeciesMapper();
    }
    ...
    public void testMap() throws IOException, InterruptedException {
        ...
        this.numberBySpeciesMapper.map(null, new Text(value), this.context);
